(function($){
    var TdGal = function(config) {
        ...
        */
        this.SPACE_BETWEEN_ELEMENTS = 0.75;
        /**
        ...
        this.TEMPLATE = ' \
            <div class="tdvp"> \
                <div class="template-element"> \
                    <div class="front applyHeight"> \
                        <div class="image"></div> \
                        <div class="applyHeight"> \
    ...
    */
    TdGal.prototype._updateElement = function(data, $el){
        if(!$el){
            ...
            var self = this;
            $el.on('click.tdGal', function(){ self._onElementClick($(this)); });
    ...
    */
    TdGal.prototype._updateSizes = function(){
        ...
        this._radius = Math.round(
            ((displayable * this._elemWidth * this.SPACE_BETWEEN_ELEMENTS) / 2) / //(this._elemWidth * this.SPACE_BETWEEN_ELEMENTS / 2) /
            Math.tan(Math.PI / nVirtualElem)
        );
    ...
    */
    ...
    TdGal.prototype._displayTag = function(offset){
        this._labelOverflow.css({ transform: 'translateX(-' + (this._contWidth * offset) + 'px)' });
    };
